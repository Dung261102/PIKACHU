...
public class GridSystem : GridAbstract
{
    ...
    protected override void LoadComponents()
    {
        base.LoadComponents();
        this.InitGridSystem();
        this.SpawnBlock(); // Gọi phương thức SpawnBlock
    }
    ...
    protected virtual void SpawnBlock()
    {
        ...
        // Tạo block tại một vị trí cụ thể
        for (int i = 0; i < nodes.Count; i++)
        {
            ...
            {
                block.gameObject.SetActive(true);
                Debug.Log("Block đã được tạo ra tại vị trí: " + pos);
            }
            else
            {
                Debug.LogError("Không thể tạo Block tại vị trí: " + pos);
            }
        }
    }
}
